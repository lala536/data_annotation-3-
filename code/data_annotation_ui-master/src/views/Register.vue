    ...
    <div style="display: flex; background-color: white; width: 25%; border-radius: 5px; overflow: hidden; padding: 10px;">
      <div style="flex: 1; display: flex; align-items: center; justify-content: center">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="registerRef">
          <div style="font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 20px">学习分析数据标注系统注册</div>
          ...
          <el-form-item>
            <el-button type="info" style="width: 100%; background-color: #3498db;" @click="register">注 册</el-button>
          </el-form-item>
          <div style="display: flex">
            <div style="flex: 1; font-size: 13px;">已经有账号了？请 <span style="color: #3498db; cursor: pointer" @click="$router.push('/login')">登录</span></div>
          </div>
        </el-form>
      </div>
    </div>
